...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _imageUploadLinker = __webpack_require__(14);

	var _imageCache = __webpack_require__(15);

	var _persistance = __webpack_require__(16);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _inlineImage = __webpack_require__(11);
		...
		function renderElement(element) {
			...
			switch (element.getType()) {
				...
				case DocumentApp.ElementType.TEXT:
					return (0, _text.renderText)(element, renderBlocks);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getCommentDelimitedContent(rawBlockName, attributes, content) {
		var serializedAttributes = !isEmpty(attributes) ? serializeAttributes(attributes) + ' ' : '';

		// Strip core blocks of their namespace prefix.
		var blockName = startsWith(rawBlockName, 'core/') ? rawBlockName.slice(5) : rawBlockName;
	...
	function Table(renderContainer) {
		...
		return function renderTable(table) {
			...
			for (var i = 0; i < numRows; i++) {
				var _renderTableRow = renderTableRow(table.getRow(i)),
				    tRow = _renderTableRow.tRow,
				    cells = _renderTableRow.cells;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function InlineImage(imageLinker) {
		...
		return function renderInlineImage(image) {
			...
			var content = '<figure><img src="' + url + '" width="' + width + '" height="' + height + '" alt="' + alt + '" title="' + title + '"></figure>';
			if (renderBlock) {
				var attributes = {
					url: url,
					alt: alt,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ListElement = exports.LIST_ELEMENT = undefined;
	...
	var LIST_ELEMENT = exports.LIST_ELEMENT = 'A8c.List';

	var ListElement = exports.ListElement = function () {
		function ListElement(parent) {
		...
		_createClass(ListElement, [{
			...
			key: 'addListItem',
			value: function addListItem(listItem) {
				var item = listItem;
	...
	function List(DocumentApp, renderContainer) {
		var tagForList = function tagForList(listItem) {
